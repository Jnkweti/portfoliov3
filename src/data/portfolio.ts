...
export const skills: Skill[] = [
	{ name: 'AWS', category: 'Cloud / Platform', proficiency: 4, sortOrder: 1 },
	{ name: 'Azure (M365 / Power)', category: 'Cloud / Platform', proficiency: 3, sortOrder: 2 },
	{ name: 'VMware / Proxmox', category: 'Cloud / Platform', proficiency: 5, sortOrder: 3 },
	{ name: 'Linux / Windows Admin', category: 'Cloud / Platform', proficiency: 5, sortOrder: 4 },
	{ name: 'Networking / TLS', category: 'Cloud / Platform', proficiency: 3, sortOrder: 5 },
	{ name: 'Terraform / IaC', category: 'DevOps / DevSecOps', proficiency: 4, sortOrder: 1 },
	{ name: 'Docker / Compose', category: 'DevOps / DevSecOps', proficiency: 4, sortOrder: 2 },
	{ name: 'Kubernetes', category: 'DevOps / DevSecOps', proficiency: 2, sortOrder: 3 },
	{ name: 'Git / GitHub / Actions', category: 'DevOps / DevSecOps', proficiency: 4, sortOrder: 4 },
	{ name: 'Ansible / Automation', category: 'DevOps / DevSecOps', proficiency: 3, sortOrder: 5 },
	{ name: 'Secure CI/CD', category: 'DevOps / DevSecOps', proficiency: 3, sortOrder: 6 },
	{ name: 'Trivy / Image Scanning', category: 'DevOps / DevSecOps', proficiency: 3, sortOrder: 7 },
	{ name: 'Java / Spring Boot', category: 'Backend / Full Stack', proficiency: 4, sortOrder: 1 },
	{ name: 'REST APIs', category: 'Backend / Full Stack', proficiency: 4, sortOrder: 2 },
	{ name: 'gRPC / Kafka', category: 'Backend / Full Stack', proficiency: 4, sortOrder: 3 },
	{ name: 'PostgreSQL / MySQL / MongoDB', category: 'Backend / Full Stack', proficiency: 2, sortOrder: 4 },
	{ name: 'Angular', category: 'Backend / Full Stack', proficiency: 3, sortOrder: 5 },
	{ name: 'ASP.NET / C#', category: 'Backend / Full Stack', proficiency: 3, sortOrder: 6 },
	{ name: 'Vulnerability Mgmt (Nessus/ACAS, Tanium)', category: 'Cybersecurity', proficiency: 5, sortOrder: 1 },
	{ name: 'Compliance / Hardening (NIST, ISO 27000, STIGs)', category: 'Cybersecurity', proficiency: 4, sortOrder: 2 },
	{ name: 'Splunk / Event Analysis', category: 'Cybersecurity', proficiency: 4, sortOrder: 3 },
	{ name: 'Wireshark / Network Analysis', category: 'Cybersecurity', proficiency: 4, sortOrder: 4 },
	{ name: 'Forescout / NAC', category: 'Cybersecurity', proficiency: 4, sortOrder: 5 },
	{ name: 'Incident Triage / RCA', category: 'Cybersecurity', proficiency: 5, sortOrder: 6 },
	{ name: 'n8n', category: 'AI / Automation', proficiency: 3, sortOrder: 1 },
	{ name: 'RAG Pipelines', category: 'AI / Automation', proficiency: 4, sortOrder: 2 },
	{ name: 'LangChain / LangFlow', category: 'AI / Automation', proficiency: 4, sortOrder: 3 },
	{ name: 'Ollama / LLM Integration', category: 'AI / Automation', proficiency: 4, sortOrder: 4 },
	{ name: 'OpenAI / Anthropic APIs', category: 'AI / Automation', proficiency: 3, sortOrder: 5 },
	{ name: 'ML Prototyping (TensorFlow / Keras)', category: 'AI / Automation', proficiency: 2, sortOrder: 6 },
	{ name: 'SDLC / Agile / Change Mgmt', category: 'Engineering / Systems', proficiency: 4, sortOrder: 1 },
	{ name: 'Documentation / Collaboration', category: 'Engineering / Systems', proficiency: 4, sortOrder: 2 },
	{ name: 'MBSE / SysML / Requirements', category: 'Engineering / Systems', proficiency: 3, sortOrder: 3 },
];
